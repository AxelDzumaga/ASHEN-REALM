...
var _run_result_count := 0
var _terminal_snapshot: Dictionary = {}


func _ready() -> void:
	SaveManager.use_isolated_test_profile(&"map3d_defeat_flow")
	...
	_check("single_result_transition", _run_result_count == 1)
	...
	_check("defeat_rewards_follow_existing_rules", run.rewards_deposited)
	...
	print(JSON.stringify({
		...
		"run_result_count": _run_result_count,
